...
VALUES
(`QA76.87 M64 1996`,`Models of neural networks III`,`[no author]`,`0387943684`,`book`,`311 p.`,`ON SHELF`,`E. Domany`,`New York : Springer-Verlag`),
...
VALUES
(`QA 76.64 W55`,`Object-oriented software engineering : the professional developer`s guide`,`[no author]`,`0201627671`,`book`,`400 p.`,`ON SHELF`,`Wokingham, England : Addison-Wesley`);
